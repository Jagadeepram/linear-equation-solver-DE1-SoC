// soc_eq_solver_hps_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module soc_eq_solver_hps_mm_interconnect_1 (
		...
		input  wire        ready_reset_reset_bridge_in_reset_reset,                                  //                                  ready_reset_reset_bridge_in_reset.reset
		...
		output wire [1:0]  ready_s1_address,                                                         //                                                           ready_s1.address
		output wire        ready_s1_write,                                                           //                                                                   .write
		input  wire [31:0] ready_s1_readdata,                                                        //                                                                   .readdata
		output wire [31:0] ready_s1_writedata,                                                       //                                                                   .writedata
		output wire        ready_s1_chipselect                                                       //                                                                   .chipselect
	);
	...
	wire   [31:0] ready_s1_agent_m0_readdata;                                    // ready_s1_translator:uav_readdata -> ready_s1_agent:m0_readdata
	wire          ready_s1_agent_m0_waitrequest;                                 // ready_s1_translator:uav_waitrequest -> ready_s1_agent:m0_waitrequest
	wire          ready_s1_agent_m0_debugaccess;                                 // ready_s1_agent:m0_debugaccess -> ready_s1_translator:uav_debugaccess
	wire   [20:0] ready_s1_agent_m0_address;                                     // ready_s1_agent:m0_address -> ready_s1_translator:uav_address
	wire    [3:0] ready_s1_agent_m0_byteenable;                                  // ready_s1_agent:m0_byteenable -> ready_s1_translator:uav_byteenable
	wire          ready_s1_agent_m0_read;                                        // ready_s1_agent:m0_read -> ready_s1_translator:uav_read
	wire          ready_s1_agent_m0_readdatavalid;                               // ready_s1_translator:uav_readdatavalid -> ready_s1_agent:m0_readdatavalid
	wire          ready_s1_agent_m0_lock;                                        // ready_s1_agent:m0_lock -> ready_s1_translator:uav_lock
	wire   [31:0] ready_s1_agent_m0_writedata;                                   // ready_s1_agent:m0_writedata -> ready_s1_translator:uav_writedata
	wire          ready_s1_agent_m0_write;                                       // ready_s1_agent:m0_write -> ready_s1_translator:uav_write
	wire    [2:0] ready_s1_agent_m0_burstcount;                                  // ready_s1_agent:m0_burstcount -> ready_s1_translator:uav_burstcount
	wire          ready_s1_agent_rf_source_valid;                                // ready_s1_agent:rf_source_valid -> ready_s1_agent_rsp_fifo:in_valid
	wire  [112:0] ready_s1_agent_rf_source_data;                                 // ready_s1_agent:rf_source_data -> ready_s1_agent_rsp_fifo:in_data
	wire          ready_s1_agent_rf_source_ready;                                // ready_s1_agent_rsp_fifo:in_ready -> ready_s1_agent:rf_source_ready
	wire          ready_s1_agent_rf_source_startofpacket;                        // ready_s1_agent:rf_source_startofpacket -> ready_s1_agent_rsp_fifo:in_startofpacket
	wire          ready_s1_agent_rf_source_endofpacket;                          // ready_s1_agent:rf_source_endofpacket -> ready_s1_agent_rsp_fifo:in_endofpacket
	wire          ready_s1_agent_rsp_fifo_out_valid;                             // ready_s1_agent_rsp_fifo:out_valid -> ready_s1_agent:rf_sink_valid
	wire  [112:0] ready_s1_agent_rsp_fifo_out_data;                              // ready_s1_agent_rsp_fifo:out_data -> ready_s1_agent:rf_sink_data
	wire          ready_s1_agent_rsp_fifo_out_ready;                             // ready_s1_agent:rf_sink_ready -> ready_s1_agent_rsp_fifo:out_ready
	wire          ready_s1_agent_rsp_fifo_out_startofpacket;                     // ready_s1_agent_rsp_fifo:out_startofpacket -> ready_s1_agent:rf_sink_startofpacket
	wire          ready_s1_agent_rsp_fifo_out_endofpacket;                       // ready_s1_agent_rsp_fifo:out_endofpacket -> ready_s1_agent:rf_sink_endofpacket
	wire          ready_s1_agent_rdata_fifo_src_valid;                           // ready_s1_agent:rdata_fifo_src_valid -> ready_s1_agent_rdata_fifo:in_valid
	wire   [33:0] ready_s1_agent_rdata_fifo_src_data;                            // ready_s1_agent:rdata_fifo_src_data -> ready_s1_agent_rdata_fifo:in_data
	wire          ready_s1_agent_rdata_fifo_src_ready;                           // ready_s1_agent_rdata_fifo:in_ready -> ready_s1_agent:rdata_fifo_src_ready
	...
	wire          ready_s1_agent_rp_valid;                                       // ready_s1_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] ready_s1_agent_rp_data;                                        // ready_s1_agent:rp_data -> router_003:sink_data
	wire          ready_s1_agent_rp_ready;                                       // router_003:sink_ready -> ready_s1_agent:rp_ready
	wire          ready_s1_agent_rp_startofpacket;                               // ready_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          ready_s1_agent_rp_endofpacket;                                 // ready_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          cmd_mux_001_src_valid;                                         // cmd_mux_001:src_valid -> ready_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                          // cmd_mux_001:src_data -> ready_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                         // ready_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                       // cmd_mux_001:src_channel -> ready_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                 // cmd_mux_001:src_startofpacket -> ready_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                   // cmd_mux_001:src_endofpacket -> ready_s1_burst_adapter:sink0_endofpacket
	wire          ready_s1_burst_adapter_source0_valid;                          // ready_s1_burst_adapter:source0_valid -> ready_s1_agent:cp_valid
	wire  [111:0] ready_s1_burst_adapter_source0_data;                           // ready_s1_burst_adapter:source0_data -> ready_s1_agent:cp_data
	wire          ready_s1_burst_adapter_source0_ready;                          // ready_s1_agent:cp_ready -> ready_s1_burst_adapter:source0_ready
	wire    [1:0] ready_s1_burst_adapter_source0_channel;                        // ready_s1_burst_adapter:source0_channel -> ready_s1_agent:cp_channel
	wire          ready_s1_burst_adapter_source0_startofpacket;                  // ready_s1_burst_adapter:source0_startofpacket -> ready_s1_agent:cp_startofpacket
	wire          ready_s1_burst_adapter_source0_endofpacket;                    // ready_s1_burst_adapter:source0_endofpacket -> ready_s1_agent:cp_endofpacket
	...
	wire  [111:0] rsp_demux_001_src0_data;                                       // rsp_demux_001:src0_data -> crosser_002:in_data
	...
	wire  [111:0] crosser_002_out_data;                                          // crosser_002:out_data -> rsp_mux:sink1_data
	...
	wire  [111:0] rsp_demux_001_src1_data;                                       // rsp_demux_001:src1_data -> crosser_003:in_data
	...
	wire  [111:0] crosser_003_out_data;                                          // crosser_003:out_data -> rsp_mux_001:sink1_data
	...
	wire          ready_s1_agent_rdata_fifo_out_valid;                           // ready_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] ready_s1_agent_rdata_fifo_out_data;                            // ready_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          ready_s1_agent_rdata_fifo_out_ready;                           // avalon_st_adapter_001:in_0_ready -> ready_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                             // avalon_st_adapter_001:out_0_valid -> ready_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                              // avalon_st_adapter_001:out_0_data -> ready_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                             // ready_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                             // avalon_st_adapter_001:out_0_error -> ready_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (ready_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (ready_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (ready_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (ready_s1_agent_m0_read),                  //                         .read
		.uav_write              (ready_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (ready_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (ready_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (ready_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (ready_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (ready_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (ready_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (ready_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (ready_s1_address),                        //      avalon_anti_slave_0.address
		.av_write               (ready_s1_write),                          //                         .write
		.av_readdata            (ready_s1_readdata),                       //                         .readdata
		.av_writedata           (ready_s1_writedata),                      //                         .writedata
		.av_chipselect          (ready_s1_chipselect),                     //                         .chipselect
		.av_read                (),                                        //              (terminated)
		.av_begintransfer       (),                                        //              (terminated)
		.av_beginbursttransfer  (),                                        //              (terminated)
		.av_burstcount          (),                                        //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clock_bridge_0_out_clk_clk),                   //             clk.clk
		.reset                   (ready_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (ready_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (ready_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (ready_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (ready_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (ready_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (ready_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (ready_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (ready_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (ready_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (ready_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (ready_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (ready_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (ready_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (ready_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (ready_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (ready_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (ready_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (ready_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (ready_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (ready_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (ready_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (ready_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (ready_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (ready_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (ready_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (ready_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (ready_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (ready_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (ready_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (ready_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (ready_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (ready_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),            // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),            //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),             //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),            //                .error
		.rdata_fifo_src_ready    (ready_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (ready_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (ready_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                        //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                          //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) ready_s1_agent_rsp_fifo (
		.clk               (clock_bridge_0_out_clk_clk),                //       clk.clk
		.reset             (ready_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (ready_s1_agent_rf_source_data),             //        in.data
		.in_valid          (ready_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (ready_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (ready_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (ready_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (ready_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (ready_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (ready_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (ready_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (ready_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                     // (terminated)
		.csr_read          (1'b0),                                      // (terminated)
		.csr_write         (1'b0),                                      // (terminated)
		.csr_readdata      (),                                          // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) ready_s1_agent_rdata_fifo (
		.clk               (clock_bridge_0_out_clk_clk),              //       clk.clk
		.reset             (ready_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (ready_s1_agent_rdata_fifo_src_data),      //        in.data
		.in_valid          (ready_s1_agent_rdata_fifo_src_valid),     //          .valid
		.in_ready          (ready_s1_agent_rdata_fifo_src_ready),     //          .ready
		.out_data          (ready_s1_agent_rdata_fifo_out_data),      //       out.data
		.out_valid         (ready_s1_agent_rdata_fifo_out_valid),     //          .valid
		.out_ready         (ready_s1_agent_rdata_fifo_out_ready),     //          .ready
		.csr_address       (2'b00),                                   // (terminated)
		.csr_read          (1'b0),                                    // (terminated)
		.csr_write         (1'b0),                                    // (terminated)
		.csr_readdata      (),                                        // (terminated)
	...
	soc_eq_solver_hps_mm_interconnect_1_router router (
	...
	soc_eq_solver_hps_mm_interconnect_1_router router_001 (
	...
	soc_eq_solver_hps_mm_interconnect_1_router_002 router_002 (
	...
	soc_eq_solver_hps_mm_interconnect_1_router_002 router_003 (
		.sink_ready         (ready_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (ready_s1_agent_rp_valid),                 //          .valid
		.sink_data          (ready_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (ready_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (ready_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clock_bridge_0_out_clk_clk),              //       clk.clk
		.reset              (ready_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) ready_s1_burst_adapter (
		.clk                   (clock_bridge_0_out_clk_clk),                   //       cr0.clk
		.reset                 (ready_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
		...
		.source0_valid         (ready_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (ready_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (ready_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (ready_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (ready_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (ready_s1_burst_adapter_source0_ready)          //          .ready
	);

	soc_eq_solver_hps_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (System_PLL_sys_clk_clk),                                                   //        clk.clk
		.reset              (ARM_A9_HPS_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	soc_eq_solver_hps_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (System_PLL_sys_clk_clk),                                                   //        clk.clk
		.reset              (ARM_A9_HPS_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	soc_eq_solver_hps_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (System_PLL_sys_clk_clk),                                //       clk.clk
		.reset               (fifo_HPS_to_FPGA_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_eq_solver_hps_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (clock_bridge_0_out_clk_clk),              //       clk.clk
		.reset               (ready_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_eq_solver_hps_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (System_PLL_sys_clk_clk),                                //       clk.clk
		.reset              (fifo_HPS_to_FPGA_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_eq_solver_hps_mm_interconnect_1_rsp_demux_001 rsp_demux_001 (
		.clk                (clock_bridge_0_out_clk_clk),              //       clk.clk
		.reset              (ready_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_eq_solver_hps_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (System_PLL_sys_clk_clk),                                                   //       clk.clk
		.reset               (ARM_A9_HPS_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_eq_solver_hps_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (System_PLL_sys_clk_clk),                                                   //       clk.clk
		.reset               (ARM_A9_HPS_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (ready_reset_reset_bridge_in_reset_reset),                                  // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (ready_reset_reset_bridge_in_reset_reset),                                  //  in_clk_reset.reset
	...
	soc_eq_solver_hps_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	soc_eq_solver_hps_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (ready_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (ready_s1_agent_rdata_fifo_out_data),      //     in_0.data
		.in_0_valid     (ready_s1_agent_rdata_fifo_out_valid),     //         .valid
		.in_0_ready     (ready_s1_agent_rdata_fifo_out_ready),     //         .ready
